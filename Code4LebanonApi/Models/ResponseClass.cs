...
public class SurveyResponse
{
    ...
    // Parsed fields (filled by background updater) to support dashboard metrics
    // Comma-separated list of interest areas (e.g., "AI Fundamentals,GenAI")
    [JsonPropertyName("areas_of_interest")]
    public string? AreasOfInterest { get; set; }

    // Motivation text (e.g., "productivity", "job_transition")
    [JsonPropertyName("motivation")]
    public string? Motivation { get; set; }

    // Challenges text or comma-separated values (e.g., "connectivity,time")
